            ...
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div className="col-span-1 md:col-span-1 flex flex-col gap-6">
                    ...
                    <div className="flex gap-4">
                        <Link target="_blank" href="https://www.instagram.com/d.f.acaosocial/" className="hover:text-primary transition-colors">
                            <Instagram className="h-5 w-5" />
                        </Link>
                        <Link target="_blank" href="https://www.facebook.com/dfacaosocial" className="hover:text-primary transition-colors">
                ...
                <div>
                    ...
                    <ul className="flex flex-col gap-4 text-sm text-gray-400">
                        <li className="flex gap-3">
                            ...
                            <span>(71) 98142-9124 / (71) 98859-9802</span>
                        </li>
                        <li className="flex gap-3">
                            <Mail className="h-4 w-4 text-primary shrink-0" />
                            <span>d.f.acaosocial@gmail.com</span>
                        </li>
                        <li className="flex gap-3">
